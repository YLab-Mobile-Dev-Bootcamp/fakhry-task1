...
TvShowDetailsDto tvShowDetailsDtoFromJson(String str) =>
    TvShowDetailsDto.fromJson(json.decode(str));

String tvShowDetailsDtoToJson(TvShowDetailsDto data) =>
...
class TvShowDetailsDto {
  ...
  factory TvShowDetailsDto.fromJson(Map<String, dynamic> json) =>
      TvShowDetailsDto(
